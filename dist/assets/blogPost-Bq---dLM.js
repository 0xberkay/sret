import"./main-CRNQqds7.js";/* empty css             */import"./three--EydoAg_.js";document.addEventListener("DOMContentLoaded",function(){const c="./blog",a=document.getElementById("blog-post-container"),d=document.getElementById("related-posts-container"),g=new URLSearchParams(window.location.search).get("id");async function m(){if(!g){s("No post ID specified");return}try{a.innerHTML=`
