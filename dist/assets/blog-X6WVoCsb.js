import"./main-CRNQqds7.js";/* empty css             */import"./three--EydoAg_.js";document.addEventListener("DOMContentLoaded",function(){const u="./blog",s=document.getElementById("blog-posts-container"),g=document.getElementById("blog-search"),a=document.getElementById("search-button"),e=document.querySelectorAll(".tag");let d=[],o=[],l="all",i="";async function m(){try{const t=await fetch(`${u}/posts.json`);if(!t.ok)throw new Error("Failed to load blog posts");return(await t.json()).posts||[]}catch(t){return console.error("Error loading blog posts:",t),[]}}async function f(){s.innerHTML=`
